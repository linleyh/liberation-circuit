...
core_hex_C, 0, 
  {object_repair, 0},
  {object_downlink, -929, 
    {component_long6, // component 12
      {object_ultra_dir:auto_att_fwd, 1105},
      {object_downlink, 0, 
      ...
      {object_downlink, 0, 
        {component_cap, // component 13
          ...
          {object_none, 0},
          {object_none, 0},
          {object_stream_dir:auto_att_right, 405},
        }
      },
      {object_pulse_l:auto_att_back, 909},
      {object_uplink, 0},
      {object_none, 0}
    }
  },
    ...
    {component_bowl, // component 1
      ...
      {object_downlink, -428, 
        {component_cap, // component 2
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move, 1179},
          {object_move:auto_move, 164},
        }
      },
      {object_downlink, -181, 
        {component_cap, // component 10
          ...
          {object_interface, 0},
          {object_interface, 0},
          {object_move:auto_move:auto_retro, -336},
        }
      },
      {object_downlink, 276, 
        {component_cap, // component 4
          {object_move:auto_move, -89},
          {object_move:auto_move, -1104},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
  ...
  {object_downlink, 828, 
    {component_long6, // component 3
      {object_ultra_dir:auto_att_fwd, -962},
      {object_none, 0},
      {object_uplink, 0},
      {object_pulse_l:auto_att_back, -909},
      {object_downlink, 0, 
        {component_cap, // component 8
          {object_stream_dir:auto_att_left, -238},
          {object_none, 0},
          {object_none, 0},
          {object_uplink, 0},
        }
