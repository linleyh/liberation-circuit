...
core_hex_A, 0, 
  ...
  {object_downlink, 0, 
    {component_prong, // component 2
      {object_downlink, -1329, 
        {component_cap, // component 3
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move:auto_retro, 890},
          {object_move:auto_move:auto_retro, -125},
        }
      },
      {object_pulse_l:auto_att_back, 238},
      {object_downlink, -1137, 
        {component_cap, // component 4
          {object_uplink, 0},
          {object_none, 0},
          {object_pulse:auto_att_left, 0},
          {object_pulse_xl:auto_att_fwd, 1160},
        }
      },
      {object_uplink, 0},
    }
  ...
  {object_downlink, 323, 
    {component_bowl, // component 1
      ...
      {object_move:auto_move, 1692},
      {object_move:auto_move, 98},
    }
  },
  {object_repair, 0},
  {object_downlink, -323, 
    {component_bowl, // component 5
      {object_uplink:auto_att_back, 0},
      {object_move:auto_move, 1876},
      {object_interface, 0},
      {object_move:auto_move, -98},
      {object_move:auto_move, -1692},
    ...
    {component_prong, // component 8
      ...
      {object_downlink, 1137, 
        {component_cap, // component 6
          {object_pulse_xl:auto_att_fwd, -1160},
          {object_pulse:auto_att_right, -94},
          {object_none, 0},
          {object_uplink, 0},
        }
      },
...
// this subroutine is only called if there's a flagship
  if (scan_single(0,0,TARGET_SCAN,0,0,100,0b1000) // 0b1000 means only processes with allocator
   || scan_single(0,0,TARGET_SCAN,0,5,100,0b11)) // 0b11 means all processes
  {
