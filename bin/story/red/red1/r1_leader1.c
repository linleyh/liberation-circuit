...
core_hex_C, 0, 
  ...
  {object_downlink, 202, 
    {component_bowl, // component 6
      {object_slice:auto_att_back, -702},
      {object_uplink, 0},
      {object_downlink, 102, 
        {component_cap, // component 7
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move, 1339},
          {object_move:auto_move, 324},
        }
      },
      {object_repair, 0},
      {object_downlink, 759, 
        {component_cap, // component 8
          {object_move:auto_move, 118},
          {object_move:auto_move, -896},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
...
switch(mode)
{
 ...
 case MODE_WANDER:
  if (distance_from_xy(move_x, move_y) < 800)
  {
   gosub start_wandering;
   break;
  }
