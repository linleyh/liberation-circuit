...
core_hex_A, 4096, 
  ...
  {object_downlink, 387, 
    {component_cap, // component 2
      {object_uplink, 0},
      {object_downlink, 1000, 
        {component_cap, // component 7
          {object_move:auto_move, -357},
          {object_move:auto_move, -1372},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
      {object_interface, 0},
      {object_move:auto_move, -779},
    }
  },
  {object_downlink, 328, 
    {component_bowl, // component 1
      ...
      {object_downlink, -124, 
        {component_cap, // component 3
          {object_uplink, 0},
          {object_pulse:auto_att_left, 339},
          {object_none, 0},
      ...
      {object_downlink, -256, 
        {component_cap, // component 9
          {object_uplink, 0},
          {object_none, 0},
          {object_pulse:auto_att_back, 551},
          {object_pulse:auto_att_back, 0},
        }
      },
      {object_pulse:auto_att_left, -374},
    }
  },
    ...
    {component_bowl, // component 6
      ...
      {object_downlink, 124, 
        {component_cap, // component 8
          {object_pulse_xl:auto_att_fwd, 0},
          {object_none, 0},
          {object_pulse:auto_att_right, -339},
          {object_uplink, 0},
        }
      },
      {object_uplink, 0},
      {object_pulse:auto_att_right, 473},
      {object_downlink, 256, 
        {component_cap, // component 10
          {object_pulse:auto_att_back, 0},
          {object_pulse:auto_att_back, -826},
          {object_none, 0},
          {object_uplink, 0},
        }
      },
