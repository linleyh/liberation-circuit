...
core_hex_A, 0, 
  ...
  {object_downlink, 570, 
    {component_side, // component 1
        ...
        {component_long5, // component 2
          {object_downlink, 95, 
            {component_cap, // component 3
              {object_uplink, 0},
              {object_move:auto_move:auto_retro, 604},
              {object_move:auto_move:auto_retro, -608},
              {object_move:auto_move:auto_retro, -1590},
            }
          },
      ...
      {object_pulse_l:auto_att_fwd, -732},
      {object_downlink, 729, 
        {component_cap, // component 4
          {object_burst_xl:auto_att_main, -445},
          {object_none, 0},
  ...
  {object_downlink, -570, 
    {component_side, // component 11
        ...
        {component_long5, // component 12
          {object_downlink, 0, 
            {component_cap, // component 13
              {object_move:auto_move, 1491},
              {object_move:auto_move:auto_retro, 598},
              {object_move:auto_move:auto_retro, -632},
              {object_uplink, 0},
            }
          },
          {object_uplink, 0},
          {object_burst_l:auto_att_main, -413},
          {object_stability:stability_11:auto_stability, 0},
          {object_pulse_l:auto_att_left, -1095},
        }
      },
      {object_downlink, -729, 
      ...
      {object_pulse_l:auto_att_fwd, 514}
    }
  }
