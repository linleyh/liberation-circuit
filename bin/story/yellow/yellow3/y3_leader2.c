...
core_hex_C, 0, 
  ...
  {object_downlink, -532, 
    {component_bowl, // component 6
      ...
      {object_slice:auto_att_right, 229},
    }
  },
  {object_downlink, -600, 
    {component_side, // component 1
      ...
      {object_downlink, -105, 
        {component_cap, // component 4
          {object_move:auto_move, 78},
          {object_move:auto_move, -937},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
      {object_downlink, -579, 
        {component_cap, // component 3
          ...
          {object_move:auto_move, 444},
        }
      },
      {object_pulse_l:auto_att_right, 663},
      {object_repair, 0}
    }
  },
  {object_repair_other, 0},
  {object_downlink, 600, 
    {component_side, // component 9
      {object_uplink, 0},
      {object_downlink, 0, 
      ...
      {object_repair, 0},
      {object_pulse_l:auto_att_left, -665}
    }
  },
  {object_downlink, 532, 
    {component_bowl, // component 12
      ...
      {object_none, 0},
      {object_none, 0},
      {object_slice:auto_att_left, -306},
      {object_pulse_l:auto_att_fwd, 0},
    }
  }
