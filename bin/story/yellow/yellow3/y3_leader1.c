...
core_hex_A, 0, 
  ...
  {object_downlink, -335, 
    {component_bowl, // component 1
      ...
      {object_none, 0},
      {object_none, 0},
      {object_slice:auto_att_fwd, -67},
      {object_none, 0},
    }
  },
  {object_downlink, -600, 
    {component_side, // component 2
      {object_downlink, 800, 
        {component_cap, // component 3
          {object_move:auto_move, 171},
          {object_move:auto_move, -844},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
      {object_uplink, 0},
      {object_pulse:auto_att_back, 635},
      {object_downlink, -706, 
        {component_cap, // component 4
          {object_uplink, 0},
          {object_interface, 0},
          {object_interface, 0},
          {object_move:auto_move, 422},
        }
      },
      {object_pulse:auto_att_right, 665},
      {object_repair, 0}
    }
  },
  {object_repair_other, 0},
  {object_downlink, 600, 
    {component_side, // component 5
      {object_uplink, 0},
      {object_downlink, -800, 
      ...
      {object_pulse:auto_att_back, -635},
      {object_repair, 0},
      {object_pulse:auto_att_left, -665}
    }
  },
  {object_downlink, 335, 
...
switch(mode)
{
 ...
 case MODE_ATTACK: // attacking something it found itself
  ...
  auto_att_fwd.fire_at(TARGET_MAIN, random(20));
