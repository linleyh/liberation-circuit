...
core_pent_C, 0, 
  ...
  {object_downlink, -1539, 
    {component_long5, // component 1
      {object_none, 0},
      {object_pulse:auto_att_back, 691},
      {object_none, 0},
      {object_uplink, 0},
      {object_pulse_xl:auto_att_right, 0},
    }
  },
  {object_downlink, -1426, 
    {component_long5, // component 2
      {object_move:auto_move:auto_retro, -1724},
      {object_uplink, 0},
      {object_downlink, -1070, 
        {component_cap, // component 3
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move, 1582},
          {object_move:auto_move, 567},
        }
      },
      {object_interface, 0},
  ...
  {object_downlink, 1539, 
    {component_long5, // component 6
      {object_none, 0},
      {object_none, 0},
      {object_pulse:auto_att_back, -470},
      {object_pulse_xl:auto_att_left, 67},
      {object_uplink, 0},
    }
  },
...
// Because this is a leader, it periodically broadcasts its presence to any nearby followers:
 broadcast(3000, // range of broadcast (in pixels).
...
if (get_damage() > 20
 && get_total_integrity() < 500)
 special_AI(1, 4);

//auto_att_fwd.attack_scan(0, 700, TARGET_FRONT);
