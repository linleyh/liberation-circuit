...
core_pent_C, 4096, 
  ...
  {object_downlink, -1284, 
    {component_long5, // component 1
      {object_downlink, 558, 
        {component_cap, // component 2
          {object_move:auto_move, -584},
          {object_move:auto_move, -1599},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
      {object_none, 0},
      {object_slice:auto_att_left, -671},
      {object_uplink, 0},
      {object_downlink, -535, 
        {component_cap, // component 3
          {object_uplink, 0},
          {object_interface, 0},
          {object_pulse:auto_att_back, 845},
          {object_move:auto_move, -170},
        }
      },
    }
  },
  {object_downlink, -851, 
    {component_prong, // component 4
      ...
      {object_none, 0},
      {object_uplink, 0},
      {object_pulse_xl:auto_att_fwd, 885},
    }
  },
  {object_downlink, 851, 
  ...
  {object_downlink, 1284, 
    {component_long5, // component 6
      ...
      {object_slice:auto_att_right, 671},
      {object_none, 0},
      {object_downlink, 535, 
