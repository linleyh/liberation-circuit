    ...
    {component_long6, // component 3
      ...
      {object_downlink, 0, 
        {component_cap, // component 4
          {object_move:auto_move, 1421},
          {object_move:auto_move, 376},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
