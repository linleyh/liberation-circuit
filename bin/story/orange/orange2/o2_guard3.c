...
core_hex_B, 8157, 
  {object_downlink, 340, 
    {component_long6, // component 8
      {object_none, 0},
      {object_burst_xl:auto_att_main, -203},
      {object_none, 1178},
      {object_none, 0},
      {object_uplink, 0},
      {object_none, 0}
  ...
  {object_downlink, 1791, 
    {component_long4, // component 5
      {object_downlink, 0, 
        {component_cap, // component 7
          {object_move:auto_move, 0},
          {object_move:auto_move, -745},
          {object_move:auto_move, -1753},
          {object_uplink, 0},
        }
      },
      {object_pulse:auto_att_back, -1151},
      {object_uplink, 0},
      {object_downlink, -1002, 
        {component_cap, // component 9
          {object_uplink, 0},
          {object_none, 0},
          {object_none, 0},
          {object_stream:auto_att_main, 681},
        }
      },
    }
  },
  {object_repair, 0},
  {object_downlink, 156, 
    {component_peak, // component 4
      {object_uplink, 0},
      {object_interface, 0},
      {object_interface, 0},
      {object_move:auto_move, 859},
      {object_move:auto_move, -1101},
    }
  },
  {object_downlink, 0, 
    {component_box, // component 1
      {object_uplink, 0},
      {object_pulse:auto_att_back, 657},
      {object_downlink, -576, 
        {component_cap, // component 2
          {object_uplink, 0},
          {object_move:auto_move, 2048},
          {object_move:auto_move, 1084},
          {object_move:auto_move, 277},
        }
      },
      {object_downlink, -1005, 
  ...
  {object_downlink, 227, 
    {component_long6, // component 6
      {object_stream:auto_att_main, -298},
      {object_none, -1219},
      {object_uplink, -739},
      {object_none, 0},
...
// guards parent
 ...
 case MODE_ATTACK:
  ...
  auto_move.approach_track(TARGET_MAIN, 0, auto_att_main, 500);
