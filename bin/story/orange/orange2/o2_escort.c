...
core_pent_A, 4096, 
  {object_downlink, 0, 
    {component_box, // component 1
      {object_uplink, 0},
      {object_interface, 0},
      {object_slice:auto_att_back, 0},
      {object_interface, 0},
    }
  },
  {object_downlink, -155, 
    {component_prong, // component 2
      {object_move:auto_move:auto_retro, -756},
      {object_uplink, 0},
      {object_move:auto_move, -2048},
      {object_move:auto_move, 1200},
    }
  },
  {object_downlink, 356, 
    {component_prong, // component 3
      {object_uplink, 0},
      {object_pulse:auto_att_left, 928},
      {object_none, 0},
      {object_pulse:auto_att_left, 94},
    }
  },
  {object_downlink, -356, 
    {component_prong, // component 4
      {object_pulse:auto_att_right, -928},
      {object_uplink, 0},
