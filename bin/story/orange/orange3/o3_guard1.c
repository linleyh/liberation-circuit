...
core_pent_A, 0, 
  ...
  {object_downlink, -407, 
    {component_prong, // component 2
      {object_move:auto_move, 311},
      {object_move:auto_move, -1246},
      {object_move:auto_move, 1758},
      {object_uplink, -1050},
    }
  },
  {object_downlink, 570, 
    {component_long5, // component 1
      {object_interface, 0},
      {object_move:auto_move, 489},
      {object_move:auto_move, 1184},
      {object_move:auto_move, -832},
      {object_uplink, -1670},
    }
  },
  {object_none, 0},
