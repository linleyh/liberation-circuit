    ...
    {component_peak, // component 1
        ...
        {component_long6, // component 6
          ...
          {object_downlink, 503, 
            {component_cap, // component 12
              {object_move:auto_move, -714},
              {object_move:auto_move, -1646},
              {object_interface, 0},
              {object_uplink, 0},
            }
          },
          ...
          {object_stream_dir:auto_att_left, -790}
        }
      },
      {object_downlink, 817, 
        {component_prong, // component 8
          {object_uplink, 0},
          {object_stream_dir:auto_att_right, 869},
          {object_none, 0},
          {object_downlink, 194, 
            {component_prong, // component 9
              ...
              {object_downlink, -484, 
                {component_cap, // component 11
                  ...
                  {object_move:auto_move, 1160},
                  {object_move:auto_move, 70},
                }
              },
              {object_none, 0},
            }
      ...
      {object_downlink, -828, 
        {component_cap, // component 4
          {object_burst_xl:auto_att_main, -1177},
          {object_uplink, 0},
          {object_none, 0},
      ...
      {object_downlink, 411, 
        {component_cap, // component 7
          ...
          {object_none, 0},
          {object_uplink, 0},
          {object_burst_l:auto_att_main, 1741},
        }
      },
    }
  },
...
if (component[9].get_component_hit()
 || component[10].get_component_hit())
{
 stability_count = 10; 
} 
