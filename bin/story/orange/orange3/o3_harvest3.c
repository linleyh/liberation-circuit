...
core_pent_C, 4096, 
    ...
    {component_box, // component 1
      ...
      {object_downlink, -520, 
        {component_cap, // component 3
          ...
          {object_move:auto_move, -884},
          {object_interface, 0},
          {object_uplink, 0},
        }
      },
      {object_downlink, -1044, 
        {component_cap, // component 6
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move, 1186},
  ...
  {object_downlink, 0, 
    {component_drop, // component 5
      {object_storage, 0},
      {object_none, 0},
      {object_pulse_l:auto_att_right, 1114},
      {object_pulse_l:auto_att_back, 268},
      {object_uplink, 0},
      {object_harvest:auto_harvest, 0}
    }
  },
  {object_downlink, 1162, 
    {component_box, // component 7
      {object_uplink, 0},
      {object_downlink, 935, 
        {component_cap, // component 8
          {object_move:auto_move, 0},
          {object_move:auto_move, -755},
          {object_uplink, 0},
          {object_interface, 0},
        }
      },
      {object_pulse_l:auto_att_back, 549},
      {object_downlink, -523, 
        {component_cap, // component 2
          {object_uplink, 0},
          {object_interface, 0},
          {object_move:auto_move, 1050},
          {object_move:auto_move, 401},
        }
      },
    }
  },
