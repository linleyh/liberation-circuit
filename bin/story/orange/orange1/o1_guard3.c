...
core_hex_B, 8157, 
  {object_downlink, 0, 
    {component_prong, // component 1
      {object_none, 0},
      {object_uplink, 0},
      {object_burst_l:auto_att_main, -1133},
      {object_none, 0},
    }
  },
  {object_downlink, 0, 
    {component_cap, // component 2
      ...
      {object_uplink, 667},
      {object_none, 0},
      {object_burst_xl:auto_att_main, 370},
    }
  },
  {object_downlink, 165, 
    {component_long5, // component 3
      {object_uplink, 0},
      {object_move:auto_move, 841},
      {object_interface, 0},
      {object_move:auto_move, -403},
      {object_move:auto_move:auto_retro, -953},
    }
  },
  {object_downlink, 156, 
    {component_bowl, // component 4
      ...
      {object_interface, 0},
      {object_downlink, -458, 
        {component_snub, // component 5
          {object_uplink, 0},
          {object_move:auto_move:auto_retro, 921},
          {object_move:auto_move, -1673},
          {object_interface, 0},
          {object_move:auto_move, 138},
        }
      },
      {object_move:auto_move, 447},
      {object_move:auto_move, -766},
    }
  },
  {object_repair, 0},
  {object_downlink, 212, 
    {component_fork, // component 6
      {object_pulse:auto_att_left, -630},
      {object_uplink, -1219},
      {object_burst_xl:auto_att_main, -739},
    }
  }
