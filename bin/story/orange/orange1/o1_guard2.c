...
core_pent_B, 4596, 
  {object_downlink, -806, 
    {component_box, // component 3
      ...
      {object_move:auto_move, -1468},
    }
  },
  {object_downlink, 167, 
    {component_bowl, // component 2
      {object_uplink, 0},
      {object_move:auto_move, 667},
      {object_interface, 0},
      {object_move:auto_move, -1174},
      {object_move:auto_move, -2048},
    }
  },
  {object_slice:auto_att_fwd, 306},
  {object_repair, 0},
  {object_downlink, -1114, 
    {component_long5, // component 1
      {object_interface, 0},
      {object_move:auto_move, -502},
      {object_move:auto_move, -48},
      {object_uplink, 0},
      {object_move:auto_move, 1094},
    }
  },
