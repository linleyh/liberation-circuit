...
core_pent_C, 4096, 
    ...
    {component_prong, // component 1
      ...
      {object_downlink, -811, 
        {component_prong, // component 2
          {object_move:auto_move, -1693},
          {object_uplink, 0},
          {object_move:auto_move, -247},
          {object_interface, 0},
        }
      },
      ...
      {object_downlink, 360, 
        {component_cap, // component 3
          {object_uplink, 771},
          {object_pulse:auto_att_back, 1050},
          {object_interface, 0},
          {object_move:auto_move, -421},
        }
      },
    }
  },
    ...
    {component_prong, // component 5
      ...
      {object_downlink, 0, 
        {component_cap, // component 6
          ...
          {object_uplink, 0},
          {object_storage, 0},
          {object_pulse_xl:auto_att_fwd, -134},
        }
      },
      {object_pulse_l:auto_att_left, 268},
    }
  },
  {object_downlink, 1162, 
    {component_prong, // component 7
      {object_uplink, 0},
      {object_none, 0},
      {object_pulse_l:auto_att_back, -1487},
      {object_downlink, -191, 
        {component_cap, // component 8
          {object_move:auto_move, 0},
          {object_move:auto_move, -565},
          {object_uplink, 0},
          {object_interface, 0},
        }
      },
