...
// rests back_init to a basic default state
																				...
																				int players)
{
 ...
 map_init.background_depth_random_freq = 0; // frequency of random addition/subtraction to background depth
 ...
 map_init.base_background_size = 15;
 ...
 map_init.base_background_size = 14;
 map_init.background_size_random_add = 6;
 map_init.background_size_random_sub = 8;
 map_init.background_size_random_freq = 70; // percent?
 map_init.base_background_depth = 2;
 map_init.background_depth_random_add = 1;
 map_init.background_depth_random_sub = 2;
 map_init.background_depth_random_freq = 70; // percent?
																					       ...
																					       unsigned int map_seed)
{
	...
	seed_mrand(map_seed);
 clear_map_init(size_blocks, players);
