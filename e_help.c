...
"get_message_channel()\nReturns the channel the current message was sent on.", // KEYWORD_SMETHOD_GET_MESSAGE_CHANNEL,
"get_message_source(target_index)\nSaves the source of the current message to targetting memory at target_index.", // KEYWORD_SMETHOD_GET_MESSAGE_SOURCE,
"get_message_x()\nReturns the (absolute) x coordinate of the sender of the current message, when it was sent.", // KEYWORD_SMETHOD_GET_MESSAGE_X,
"get_message_y()\nReturns the (absolute) y coordinate of the sender of the current message, when it was sent.", // KEYWORD_SMETHOD_GET_MESSAGE_Y,
...
"special_AI(value1, value2)\nSpecial method for story AI chatter. Does nothing if called by anyone else.", // KEYWORD_SMETHOD_SPECIAL_AI,
