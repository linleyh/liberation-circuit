...
DSB_OBJECT_ATTACK_SURGE,
DSB_OBJECT_ATTACK_SURGE_DIR,
#define DSB_OBJECT_ATTACK_LAST DSB_OBJECT_ATTACK_SURGE_DIR
...
DSB_AUTOCODE_HARASS,
#define DSB_AUTOCODE_LAST DSB_AUTOCODE_HARASS
